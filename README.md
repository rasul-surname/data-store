# Motion Cube
Список задач и кликер с использованием локального хранилища браузера. Проект разработан в учебных целях, для тренировки навыков адаптивной вёрстки.
...
- [ ] Создать 1 функцию для записи цвета в localStorage
- [ ] Оптимизировать код
- [ ] Предложите своё?
